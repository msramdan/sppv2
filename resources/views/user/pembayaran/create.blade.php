                                    ...
                                    <div id="accordion">
                                        <div class="accordion" v-for="(row, p) in tagihan">
                                            ...
                                            <div class="accordion-body collapse" :id="'panel-body-'+row.id"
                                                ...
                                                <div class="row">
                                                    <div class=""
                                                        v-bind:class="{ 'col-md-10 col-10': row.jenis_pembayaran.tipe ==='bebas', 'col-md-4 col-6': row.jenis_pembayaran.tipe ==='bulanan' }"
                                            ...
                                            <div>
                                                ...
                                                <div v-else class="d-flex justify-content-center">
                                                    <img alt="image" style="opacity: 0.3" height="90px" width="90px"
                                                        src="{{ asset('/img/undraw_empty_cart_co35.png') }}">
                                                </div>
                                            </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content bg-light text-dark shadow">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a :href="'../invoice?metode=' + metode" type="button"
