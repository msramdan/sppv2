                    ...
                    <div class="card">
                        <div class="card-header iseng-sticky bg-white">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('pembayaran.cetak', $detail->id) }}" target="blank"
                                    class="btn btn-secondary btn-icon" data-toggle="tooltip" data-placement="top" title=""
                                    ...
                                    <div>
                                        @foreach ($detail->detail_pembayaran as $item)
                                            <div class="d-flex justify-content-between border-bottom py-2">
                                                ...
                                                <div>
                                                    <span>Nominal : Rp. {{ number_format($item->harga) }}</span>
                                                    <br>

                                                    <span>Dibayar : Rp. {{ number_format($item->total_bayar) }}</span>
                                                    <br>
                                                    <span>Sisa : Rp. {{ number_format($item->sisa) }}</span>
                                                </div>
                                            </div>
                                        @endforeach
